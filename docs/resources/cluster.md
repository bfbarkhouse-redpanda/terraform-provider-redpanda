...
- `computed_properties_json` (String) Computed properties for the cluster in JSON format. This is read-only and shows the actual configuration applied by Redpanda.
